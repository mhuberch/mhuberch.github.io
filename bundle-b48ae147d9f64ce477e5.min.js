        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    alert(coloring);
                    if (!(coloring == 1)) return [3 /*break*/, 2];
                    console.log("Starting coloring in mode 1");
                    return [4 /*yield*/, _graphState__WEBPACK_IMPORTED_MODULE_3__["default"].getProperty("Most recent k-color check", true)];
                case 1:
                    chromaticNumber = _a.sent();
                    console.log("Chromatic number is given by " + chromaticNumber);
                    graphKColorable = _graphState__WEBPACK_IMPORTED_MODULE_3__["default"].state.kColorable;
                    ...
                    return [3 /*break*/, 6];
                case 2:
                    if (!(coloring === 2)) return [3 /*break*/, 5];
...
/******/ })()
;
//# sourceMappingURL=bundle-b48ae147d9f64ce477e5.min.js.map