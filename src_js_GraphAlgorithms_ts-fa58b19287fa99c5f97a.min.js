    ...
    GraphAlgorithms.kColoringBruteForce = function (kcolor, G) {
        ...
        var kColoringBruteForceRecursive = function (kcolor, curNode, color, G) {
            ...
            for (var j = 1; j <= kcolor; j++) {
                color[curNode] = j;
                var recAnswer_1 = kColoringBruteForceRecursive(kcolor, curNode + 1, color);
        ...
        var recAnswer = kColoringBruteForceRecursive(kcolor, 0, color);
...
//# sourceMappingURL=src_js_GraphAlgorithms_ts-fa58b19287fa99c5f97a.min.js.map