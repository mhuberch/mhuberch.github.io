...
var makeAndPrintkColoringBruteForce = function () {
    ...
    _util_genericHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].showFormModal(function ($modal, values) {
        ...
        var w = UIInteractions.getWorkerIfPossible(function (e) {
            ...
            console.log(_graphState__WEBPACK_IMPORTED_MODULE_2__["default"].state);
...
var UIInteractions = /** @class */ (function () {
    ...
    UIInteractions.resetGraphColoringWelsh = function () {
        var _this = this;
        console.log("Hi, I'm resetGraphColoringWelsh");
        return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                _graphState__WEBPACK_IMPORTED_MODULE_2__["default"].graphProperties["Approx. Chromatic Welsh"] = null;
                _graphState__WEBPACK_IMPORTED_MODULE_2__["default"].setUpToDate(true, ["Approx. Chromatic Welsh", "graphColoringWelsh"]);
                _graphState__WEBPACK_IMPORTED_MODULE_2__["default"].state.graphColoringWelsh = null;
                return [2 /*return*/];
            });
        }); });
    };
...
/* harmony export */ });
function Worker_fn() {
  return new Worker(__webpack_require__.p + "GraphAlgorithmWorker-5fad7374ad8392703bb1.min.worker.js");
}
...
/******/ 			return "" + chunkId + "-" + {"src_js_util_predefinedGraphs_ts":"88284ae1dfe6c45ccb60","src_EN_US_ts":"231fed76a8bb6fb0d47f","src_custom_d_ts":"cc488757333ac874f6ba","src_js_GraphAlgorithms_ts":"9e012471b759efb7e12e","src_js_classes_SpanningTree_ts":"a6d712f9d026bc75194c","src_js_dataImportExport_ts":"b441eff08bdb25f0b37f","src_js_workers_GraphAlgorithmWorker_ts":"85b9aa75035adf79657a","src_js_workers_pwaServiceWorker_ts":"25c948cdc5f264cad919","src_overloadTypes_d_ts":"71c8dfa2c6943d2e4d22"}[chunkId] + ".min.js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=bundle-60b4df583078a7a41168.min.js.map