...
var UIInteractions = /** @class */ (function () {
    ...
    UIInteractions.makeAndPrintkColoringBruteForce = function () {
        ...
        UIInteractions.isRunning[myName] = true;
        return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
            var a, printKCBF, iStartedProgress, _a, w_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        a = {
                            kColorable: _graphState__WEBPACK_IMPORTED_MODULE_2__["default"].state.kColorable
                        };
                        printKCBF = function () {
                            ...
                            var p = "<h3>" + _languages__WEBPACK_IMPORTED_MODULE_6__.current.kColoringBruteForceTitle + "</h3>"; //<hr>${help.htmlEncode(p)}`;
                            p += "<br/><button class='btn btn-primary' onclick='main.applyColors()'>" + _languages__WEBPACK_IMPORTED_MODULE_6__.current.ReColor + "</button>";
                            _util_genericHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].printout(p);
                            window.main.applyColors();
                        };
                        iStartedProgress = UIInteractions.startLoadingAnimation();
                        _a = a.chromaticNumber !== null;
...
/******/ 			return "" + chunkId + "-" + {"src_js_util_predefinedGraphs_ts":"55adc49b04f1236489a1","src_EN_US_ts":"a99be4d0da7852b36c82","src_custom_d_ts":"cc488757333ac874f6ba","src_js_GraphAlgorithms_ts":"9306e62703c6f8a0e313","src_js_classes_SpanningTree_ts":"a6d712f9d026bc75194c","src_js_dataImportExport_ts":"41ea575e9abe967ce765","src_js_workers_GraphAlgorithmWorker_ts":"49f289a404761758d2d1","src_js_workers_pwaServiceWorker_ts":"25c948cdc5f264cad919","src_overloadTypes_d_ts":"71c8dfa2c6943d2e4d22"}[chunkId] + ".min.js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=bundle-f8e0e39f72388e6b8810.min.js.map