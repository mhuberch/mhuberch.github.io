...
var GraphAlgorithms = /** @class */ (function () {
    ...
    GraphAlgorithms.kColoringBruteForce = function (G) {
        // export type kColorResult = { kcolor: number; kcolorable: boolean; color: number[]};
        if (G === void 0) { G = _graphState__WEBPACK_IMPORTED_MODULE_4__["default"].graph; }
        console.log("Hi there. I'm kColoringBruteForce");
        var recAnswer = _this.kColoringBruteForceRecursive;
        return { kcolor: 1, kcolorable: false, color: [] };
    };
    GraphAlgorithms.kColoringBruteForceRecursive = function (kcolor, curNode, color, G) {
        if (G === void 0) { G = _graphState__WEBPACK_IMPORTED_MODULE_4__["default"].graph; }
        ...
        for (var j = 1; j <= kcolor; j++) {
            color[curNode] = j;
            var recAnswer = _this.kColoringBruteForceRecursive(kcolor, curNode + 1, color);
...
//# sourceMappingURL=src_js_GraphAlgorithms_ts-778fda2af07f74e989d5.min.js.map