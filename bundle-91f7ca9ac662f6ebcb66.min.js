...
_sentry_browser__WEBPACK_IMPORTED_MODULE_6__.init({
    ...
    beforeSend: function (event) {
        event.user = {};
        event.user.graph = _main__WEBPACK_IMPORTED_MODULE_2__["default"].graphState.graph;
        return event;
    }
});
...
var basicColors = ["gray", '#ff3f3f ', '#ffbf64', '#ffff00', '#00ff80', '#00a0ff', '#f964ff'];
var basicColorsLabel = ["not colored", "1: red", "2: orange", "3: yellow", "4: green", "5: blue", "6: violet"];
var basicColorsNum = basicColors.length;
var basicColorsIndices = Array.from(Array(basicColorsNum).keys());
var self = {
    ...
    visOptions: {
        ...
        manipulation: {
            addNode: function (data, callback) { return __awaiter(void 0, void 0, void 0, function () {
                var options, _a, _b, _c, _d, _e, _f, _g, _h, _j, $popup;
                return __generator(this, function (_k) {
                    switch (_k.label) {
                        ...
                        case 2:
                            ...
                            $popup = _util_genericHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].makeFormModal("Add Node", "Save", options);
                            $popup.on("click", ".btn-success", function () {
                                $popup.modal("hide");
                                self.saveData(data, callback, "add", $popup.find("input").first().val(), basicColors[$popup.find("select").first().val()]);
            ...
            editNode: function (data, callback) {
                ...
                var $popup = _util_genericHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].makeFormModal("Edit Node", "Save", options);
                $popup.on("click", ".btn-success", function () {
                    $popup.modal("hide");
                    self.saveData(data, callback, "editNode", $popup.find("input").first().val(), basicColors[$popup.find("select").first().val()]);
                }).on("click", ".btn-cancel", function () {
                    $popup.modal("hide");
                    self.cancelEdit(callback);
                }).on("hidden.bs.modal", function () {
    ...
    applyColors: function () { return __awaiter(void 0, void 0, void 0, function () {
        var coloring, graphColors, chromaticNumber, addColors, colors, G;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (window.settings.getOption("direction")) {
                ...
                case 3:
                    ...
                    return [2 /*return*/];
                case 4:
                    addColors = randomcolor__WEBPACK_IMPORTED_MODULE_2___default()({ count: chromaticNumber > basicColorsNum + 1 ? chromaticNumber - basicColorsNum : 1, luminosity: "light" });
...
/* harmony export */ });
function Worker_fn() {
  return new Worker(__webpack_require__.p + "GraphAlgorithmWorker-70e3054ac9cfa5e027f2.min.worker.js");
}
...
/******/ 			return "" + chunkId + "-" + {"src_js_util_predefinedGraphs_ts":"2bc1326c170cc9942da2","src_EN_US_ts":"af019e638c49e9abfb08","src_custom_d_ts":"cc488757333ac874f6ba","src_js_GraphAlgorithms_ts":"c2b8d425f7c0a436a122","src_js_classes_SpanningTree_ts":"a6d712f9d026bc75194c","src_js_dataImportExport_ts":"11bf3e5e66772dadaf87","src_js_workers_GraphAlgorithmWorker_ts":"49f289a404761758d2d1","src_js_workers_pwaServiceWorker_ts":"25c948cdc5f264cad919","src_overloadTypes_d_ts":"71c8dfa2c6943d2e4d22"}[chunkId] + ".min.js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=bundle-91f7ca9ac662f6ebcb66.min.js.map