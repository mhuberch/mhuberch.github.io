...
var makeAndPrintkColoringBruteForce = function () {
    var myName = _languages__WEBPACK_IMPORTED_MODULE_6__.current.kColoringBruteForce;
    if (UIInteractions.isRunning[myName]) {
        UIInteractions.printAlreadyRunning(myName);
        return;
    }
    ...
    _util_genericHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].showFormModal(function ($modal, values) {
        ...
        var w = UIInteractions.getWorkerIfPossible(function (e) {
            ...
            console.log(a);
            _graphState__WEBPACK_IMPORTED_MODULE_2__["default"].graphProperties.colormode = 1;
            ...
            console.log("check ");
            console.log(_graphState__WEBPACK_IMPORTED_MODULE_2__["default"].getProperty("Most recent k-color check"));
            if (_graphState__WEBPACK_IMPORTED_MODULE_2__["default"].state.kColorable === null || _graphState__WEBPACK_IMPORTED_MODULE_2__["default"].getProperty("Most recent k-color check") == null) {
                _graphState__WEBPACK_IMPORTED_MODULE_2__["default"].graphProperties["Most recent k-color check"] = -1;
                _graphState__WEBPACK_IMPORTED_MODULE_2__["default"].state.kColorable = {};
                console.log("Newly Sset up; kColorable and MostRecentKColorCheck");
            }
            console.log("Check a. kColorable: " + a.kColorable);
            if (a.kColorable) {
                _graphState__WEBPACK_IMPORTED_MODULE_2__["default"].graphProperties["Most recent k-color check"] = a.kColor;
                _graphState__WEBPACK_IMPORTED_MODULE_2__["default"].setUpToDate(true, ["Most recent k-color check", "kColorable"]); // TODO: What about kColor dictionary if changing the graph?
                _graphState__WEBPACK_IMPORTED_MODULE_2__["default"].state.kColorable[kColor] = a.color;
                console.log("Saving output from kColor-Algorithm");
                console.log(a.color);
                console.log(_graphState__WEBPACK_IMPORTED_MODULE_2__["default"].state.kColorable[3]);
                console.log(_graphState__WEBPACK_IMPORTED_MODULE_2__["default"].getProperty("kColorable", true));
                console.log("Building output string");
                var p = _util_genericHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].stringReplacement(_languages__WEBPACK_IMPORTED_MODULE_6__.current.kColoringSuccess, a.kColor + "");
                p = "<h3>" + _languages__WEBPACK_IMPORTED_MODULE_6__.current.kColoringBruteForceTitle + "</h3><hr>" + _util_genericHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].htmlEncode(p);
                ...
                var p = _util_genericHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].stringReplacement(_languages__WEBPACK_IMPORTED_MODULE_6__.current.kColoringFail, a.kColor + "");
                _graphState__WEBPACK_IMPORTED_MODULE_2__["default"].state.kColorable[kColor] = [];
                _util_genericHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].printout(p);
            }
    ...
    }, _languages__WEBPACK_IMPORTED_MODULE_6__.current.kColoringBruteForce, _languages__WEBPACK_IMPORTED_MODULE_6__.current.Go, [{
            type: "numeric", initialValue: 1, label: _languages__WEBPACK_IMPORTED_MODULE_6__.current.NumberOfColors,
            validationFunc: function (v) {
                return v > 0 || _languages__WEBPACK_IMPORTED_MODULE_6__.current.NumberOfColorsPositiveError;
            }
        }]);
};
...
var UIInteractions = /** @class */ (function () {
        ...
        return [
            {
                ...
                name: _languages__WEBPACK_IMPORTED_MODULE_6__.current.CheckColoring,
                directional: false,
            ...
            {
                //name: "Graph Coloring Welsh",
                name: _languages__WEBPACK_IMPORTED_MODULE_6__.current.GraphColoringGreedy,
                directional: false,
                applyFunc: UIInteractions.makeAndPrintGraphColoringWelsh,
                display: true
            },
            {
                name: _languages__WEBPACK_IMPORTED_MODULE_6__.current.kColoringBruteForce,
                directional: false,
                applyFunc: function () {
    ...
    UIInteractions.registerListeners = function () {
        ...
        makeSimpleClickListener("#import-graph-g1", function () { return __awaiter(_this, void 0, void 0, function () {
            var imp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, __webpack_require__.e(/*! import() */ "src_js_dataImportExport_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./dataImportExport */ "./src/js/dataImportExport.ts"))];
        ...
        makeSimpleClickListener("#import-graph-g2", function () { return __awaiter(_this, void 0, void 0, function () {
            var imp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, __webpack_require__.e(/*! import() */ "src_js_dataImportExport_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./dataImportExport */ "./src/js/dataImportExport.ts"))];
        ...
        makeSimpleClickListener("#import-graph-g3", function () { return __awaiter(_this, void 0, void 0, function () {
            var imp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, __webpack_require__.e(/*! import() */ "src_js_dataImportExport_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./dataImportExport */ "./src/js/dataImportExport.ts"))];
        ...
        makeSimpleClickListener("#import-graph-g4", function () { return __awaiter(_this, void 0, void 0, function () {
            var imp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, __webpack_require__.e(/*! import() */ "src_js_dataImportExport_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./dataImportExport */ "./src/js/dataImportExport.ts"))];
        ...
        document.querySelector("#graphloadDropdown").innerText = _languages__WEBPACK_IMPORTED_MODULE_6__.current.LoadGraphs;
        document.querySelector("#import-graph-g1").innerText = "Graph G1";
        document.querySelector("#import-graph-g2").innerText = "Graph G2";
        document.querySelector("#import-graph-g3").innerText = "Graph G3";
        document.querySelector("#import-graph-g4").innerText = "Graph G4";
    ...
    UIInteractions.checkGraphColoring = function () {
        ...
        return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
            var a, printCC, iStartedProgress, w;
            return __generator(this, function (_a) {
                if (window.settings.getOption("direction")) {
                    UIInteractions.isRunning[myName] = false;
                    return [2 /*return*/, resolve()];
                }
                a = { from: [], to: [], num: -1, confList: [] };
                printCC = function () {
                    var p = _util_genericHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].stringReplacement(_languages__WEBPACK_IMPORTED_MODULE_6__.current.NumberOfConflicts, a.num + "");
                    var conflist = a.confList;
                    p += "\n\n";
                    conflist.forEach(function (v, i) {
                        p += _util_genericHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].stringReplacement(_languages__WEBPACK_IMPORTED_MODULE_6__.current.NodeIsInConflictWith, (i + 1).toString(), _graphState__WEBPACK_IMPORTED_MODULE_2__["default"].nodeIDToLabel(v[0]), _graphState__WEBPACK_IMPORTED_MODULE_2__["default"].nodeIDToLabel(v[1]) + "") + "\n";
                    });
                    p = "<h3>" + _languages__WEBPACK_IMPORTED_MODULE_6__.current.CheckColoringTitle + "</h3><hr>" + _util_genericHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].htmlEncode(p);
                    _util_genericHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].printout(p);
                };
                iStartedProgress = UIInteractions.startLoadingAnimation();
                w = UIInteractions.getWorkerIfPossible(function (e) {
    ...
    UIInteractions.makeAndPrintGraphColoringWelsh = function () {
        var _this = this;
        var myName = _languages__WEBPACK_IMPORTED_MODULE_6__.current.GraphColoringGreedy;
        if (UIInteractions.isRunning[myName]) {
            UIInteractions.printAlreadyRunning(myName);
            return Promise.reject(_languages__WEBPACK_IMPORTED_MODULE_6__.current.TaskAlreadyRunning);
        }
        UIInteractions.isRunning[myName] = true;
        return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
            var a, _a, printGC, iStartedProgress, _b, w_1;
...
var self = {
    ...
    applyColors: function () { return __awaiter(void 0, void 0, void 0, function () {
        var coloring, graphColors, chromaticNumber, graphKColorable, basicColors, addColors, colors, G;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (window.settings.getOption("direction")) {
                    ...
                    alert(coloring);
                    if (!(coloring == 1)) return [3 /*break*/, 3];
                    console.log("Starting coloring in mode 1");
                    return [4 /*yield*/, _graphState__WEBPACK_IMPORTED_MODULE_3__["default"].getProperty("Most recent k-color check")];
                case 1:
                    chromaticNumber = _a.sent();
                    console.log("Chromatic number is given by " + chromaticNumber);
                    return [4 /*yield*/, _graphState__WEBPACK_IMPORTED_MODULE_3__["default"].getProperty("kColorable", true)];
                case 2:
                    graphKColorable = _a.sent();
                    // const graphKColorable = GraphState.state.kColorable;
                    // if (graphKColorable === null) {
                    //     return;
                    // }
                    ...
                    return [3 /*break*/, 7];
                case 3:
                    if (!(coloring === 2)) return [3 /*break*/, 6];
...
/* harmony export */ });
function Worker_fn() {
  return new Worker(__webpack_require__.p + "GraphAlgorithmWorker-f2c18fe943bf8b638011.min.worker.js");
}
...
/******/ 			return "" + chunkId + "-" + {"src_js_util_predefinedGraphs_ts":"88284ae1dfe6c45ccb60","src_EN_US_ts":"231fed76a8bb6fb0d47f","src_custom_d_ts":"cc488757333ac874f6ba","src_js_GraphAlgorithms_ts":"97f316907a89ba0a4fd9","src_js_classes_SpanningTree_ts":"a6d712f9d026bc75194c","src_js_dataImportExport_ts":"c63bdcf1ad73d46e74b8","src_js_workers_GraphAlgorithmWorker_ts":"49f289a404761758d2d1","src_js_workers_pwaServiceWorker_ts":"25c948cdc5f264cad919","src_overloadTypes_d_ts":"71c8dfa2c6943d2e4d22"}[chunkId] + ".min.js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=bundle-888ed23269c4ef7539a6.min.js.map