...
var self = {
        ...
        if (format.toLowerCase() === "json") {
            try {
                ...
                if ("nodes" in n && "edges" in n) {
                    ...
                    _util_genericHelpers__WEBPACK_IMPORTED_MODULE_0__["default"].showSimpleModal("Data Import Error", "<p>The provided input does not conform the the" +
                        " import specifications.</p>");
                }
            }
            catch (err) {
                _util_genericHelpers__WEBPACK_IMPORTED_MODULE_0__["default"].showSimpleModal("JSON Parse Error", "<p>There was an error parsing your input as JSON.</p><pre>" + err + "</pre>");
            }
        }
            ...
            lines.forEach(function (l) {
                ...
                if (vals[0].toLowerCase() === "p") {
                    if (vals[1].toLowerCase() !== "edge") {
                        _util_genericHelpers__WEBPACK_IMPORTED_MODULE_0__["default"].showSimpleModal("DIMACS Parse Error", "<p>Sorry, but I only know how to parse" +
            ...
            if (graph_1 === null && !error_1) {
                _util_genericHelpers__WEBPACK_IMPORTED_MODULE_0__["default"].showSimpleModal("DIMACS Parse Error", "<p>No program line found!</p>");
                error_1 = true;
            }
            if (!error_1) {
            ...
            _util_genericHelpers__WEBPACK_IMPORTED_MODULE_0__["default"].showSimpleModal("Unrecognized Input Format", "<p>The format of your input is incorrect.</p>");
        }
    },
    makeImportTextModal: function () {
        ...
        }, "Import Graph From Text", "Import", [{ type: "textarea", label: "Input Text", extraAttrs: { style: "height: 20vh; min-height:400px;" } },
    ...
    makeExportFileModal: function () {
        _util_genericHelpers__WEBPACK_IMPORTED_MODULE_0__["default"].showFormModal(null, "Export Graph To File", null, [{
                type: "button",
    ...
    makeExportTextModal: function () {
        _util_genericHelpers__WEBPACK_IMPORTED_MODULE_0__["default"].showFormModal(null, "Export Graph To Text", null, [{
                type: "button",
                initialValue: "Export to JSON",
                onclick: function () {
...
//# sourceMappingURL=src_js_dataImportExport_ts-d9746b6dd27392a26b81.min.js.map